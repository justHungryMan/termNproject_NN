...
def _infer(path_to_input_dir: str, path_to_output_dir: str, path_to_checkpoint: str, dataset_name: str, backbone_name: str, prob_thresh: float):
...
if __name__ == '__main__':
    def main():
        ...
        parser.add_argument('output', type=str, help='path to output result dir')
        args = parser.parse_args()

        path_to_input_dir = args.input
        ...
        _infer(path_to_input_dir, path_to_output_dir, path_to_checkpoint, dataset_name, backbone_name, prob_thresh)
